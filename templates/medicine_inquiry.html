...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$subject = "SriManojPharma Medicine Inquiry";
	$headers = "From:" . $from;
	$message = "Name=" . $First_Name . $Last_Name . ",Email=" . $Email . ",Mobile=" . $Mobile . ",Medicine Name=" . $Medicine . ",Quantity=" . $Quantity . ",Delivery Address=" . $Address;
	// echo($message);
	...
	<nav class="navbar navbar-expand-lg navbar-light " style="background-color: #FFDDDD;">
		...
		<div class="collapse navbar-collapse" id="main_nav">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link" href="medicine-inquiry.php"> <b style="color:red"><u> Medicine Inquiry </u></b></a></li>
...
<body style="background-color:#FFDDDD">
	...
	<main>
		...
		<!-- career form -->
		<div>
			<form class="form-register" action="medicine-inquiry.php" method="POST">
				<div class="row">
				...
				<div class="row">
					<div class="form-group col-md-4">
						...
						<input type="" class="form-control" name="Medicine-name" id="Medicine-name" aria-describedby="emailHelp" placeholder="" required style="background-color:white">
					</div>
					<div class="form-group col-md-4">
						<label>Quantity </label>
						<input type="" class="form-control" name="Quantity" id="Quantity" aria-describedby="emailHelp" placeholder="" style="background-color:white">
					</div>
					<div class="form-group col-md-4">
						<label>Prescription Image </label>
						<input type="file" class="form-control" name="Prescription-Image" id="Prescription-Image" aria-describedby="emailHelp" placeholder="" style="background-color:white">
					</div>
				</div>
				<div class="form-group">
					<label>Delivery Address *</label>
					<input type="address" class="form-control" name="Delivery-Address" id="Delivery-Address" aria-describedby="emailHelp" placeholder="" required style="background-color:white">
				</div>
				<div class="form-group">
