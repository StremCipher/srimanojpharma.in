	...
	<nav class="navbar navbar-expand-lg navbar-light " style="background-color: #FFDDDD;">
		...
		<div class="collapse navbar-collapse" id="main_nav">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link" href="why-srimanojpharma.php"><b style="color:red"><u> Why Srimanojpharma</u></b></a></li>
...
<body style="background-color:#FFDDDD">
	...
	<main>
		<div>
			<u>
				<h3 style="text-align:center">Why SriManojPharma</h3>
			</u>
		</div>
		<div class="card " style="background-color:white;margin:5% 10% 10% 10%;border-radius:20px">
			<div class="card-body text-center">
				<h3 class="card-text" style="font-family: 'Brush Script MT', cursive"> SirManoj Pharma is one of the Oldest pharmaceutical Company in
					Shonbhadra District. <br>
					Srimanoj Pharma Provide Medicine to Both Large Hospital and Individual too so if you are an individual consumer then you are
					buying medicine at manufature level cost becuase SriManoj Pharma has direct connection with large Manufacturer and also
					SirManojPharma is itself a Medicine Manufacturer.
					<br>
					SriManoj Pharma assure to each of their costomer that they will be getting medicine at lowest price from the market.
					</p>
			</div>
		</div>
	</main>
